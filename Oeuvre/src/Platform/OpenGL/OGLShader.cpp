...
namespace Oeuvre
{
	OGLShader::OGLShader(const char* vertexPath, const char* fragmentPath, const char* geometryPath)
	{
	...
	{
		glUniformMatrix3fv(glGetUniformLocation(m_RendererID, name.c_str()), 1, GL_FALSE, &value[0][0]);
	}
